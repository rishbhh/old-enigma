...
objects[0] = { obj: test, text: 'Designers' };
objects[1] = { obj: test2, text: 'Marketers' };
objects[2] = { obj: test3, text: 'Engineers' };
objects[3] = { obj: test4, text: 'Strategists' };
objects[4] = { obj: test5, text: 'Visionaries' };
objects[5] = { obj: test6, text: 'Enigma' };
...
loader.load('assets/3d/TheRock2.obj', function (object) {
    renderStart = 0;
    ...
    // objects.push(object);
    objects[0] = { obj: object, text: 'Designers' };
...
loader.load('assets/3d/micro.obj', function (object) {
    renderStart = 0;
    object.traverse(function (child) {
        if (child instanceof THREE.Mesh) {
    ...
    object.visible = false;
    // objects.push(object);
    objects[1] = { obj: object, text: 'Marketers' };
    scene.add(object);
    animate()
}, onProgress, onError);
...
group.add(cube2);
group.visible = false;
objects[2] = { obj: group, text: 'Engineers' };
scene.add(group);


loader.load('assets/3d/suitcase.obj', function (object) {
    renderStart = 0;
    object.traverse(function (child) {
        if (child instanceof THREE.Mesh) {
    ...
    object.rotation.z = .2;
    object.visible = false;
    objects[3] = { obj: object, text: 'Strategists' };
    scene.add(object);
    animate()
}, onProgress, onError);


loader.load('assets/3d/cup.obj', function (object) {
    renderStart = 0;
    object.traverse(function (child) {
        if (child instanceof THREE.Mesh) {
    ...
    object.visible = false;
    // objects.push(object);
    objects[4] = { obj: object, text: 'Visionaries' };
    scene.add(object);
    animate()
}, onProgress, onError);
...
group.add(sphere2);
group.visible = false;
objects[5] = { obj: group, text: 'Enigma' };
scene.add(group);
        ...
        if (renderStart == 1 && docScroll < docHeight / 2) {
            ...
            if (anim.elem != nextElem) {
                ...
                for (var i = 0; i < objects.length; i++) {
                    ...
                    document.getElementById('y_' + objects[i].text).className = 'below_title_text';
                ...
                document.getElementById('y_' + objects[anim.elem].text).className = 'below_title_text active';
...
function material() {
    ...
    line = loader.load('assets/3d/line.png');
    ...
    line2 = loader.load('assets/3d/lineE.png');
    ...
    line3 = loader.load('assets/3d/line.png');
    ...
    line4 = loader.load('assets/3d/line3.png');
